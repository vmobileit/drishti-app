...
public class DoctorPNCScreenActivityTest  extends ActivityInstrumentationTestCase2<DoctorPNCScreenActivity> {
    ...
    public void testDataSetToViews() {
        ...
        doctorPNCScreenActivity.setDatatoViews(jsondata.toString());
